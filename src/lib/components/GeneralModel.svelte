...
<div class="general-model">
  <div class="wrapper">
    ...
    <Gauge value={$modulesStore.Weights[0]} name="W1 #001" style={weightStyleOne} />
    <Gauge value={$modulesStore.Weights[1]} name="W1 #003" style={weightStyleTwo} />
    <Gauge value={$modulesStore.Weights[2]} name="W1 #007" style={weightStyleThree} />
    <Gauge value={$modulesStore.Pressure} name="PT #009" style={pressureStyleOne} />
