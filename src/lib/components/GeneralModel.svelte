...
<div class="general-model">
  <div class="wrapper">
    ...
    <Gauge name="W1 #001" style={weightStyleOne} />
    <Gauge name="W1 #003" style={weightStyleTwo} />
    <Gauge name="W1 #007" style={weightStyleThree} />
    <Gauge name="PT #009" style={pressureStyleOne} />
    <Thermometer name="TI #004" style={temperatureStyleOne} />
    <Thermometer name="TI #005" style={temperatureStyleTwo} />
    <Thermometer name="TI #008" style={temperatureStyleThree} />
    <Humidity name="LS #002" style={humidityStyleOne} />
    <Humidity name="MI #006" style={humidityStyleTwo} />
  </div>
</div>
